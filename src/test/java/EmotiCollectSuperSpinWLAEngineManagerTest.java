...
public class EmotiCollectSuperSpinWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(EmotiCollectSuperSpinWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/EmotiCollectSuperSpinWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/EmotiCollectSuperSpinWLAIW/InitOutcome.xml").getDocumentElement();
